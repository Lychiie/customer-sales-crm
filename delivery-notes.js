(() => {
  ...
  style.textContent = `
    ...
    .dn-sheet td.dn-description{white-space:pre-wrap;overflow-wrap:anywhere}.dn-sheet td small{white-space:pre-wrap;margin-top:1mm}.dn-empty td{height:5.4mm;padding:0}.dn-sheet footer{margin-top:6mm}
