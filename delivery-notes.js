(() => {
  ...
  style.textContent = `
    ...
    .dn-sheet td strong{font-weight:500;display:block;white-space:pre-wrap}.dn-sheet td small{white-space:pre-wrap;margin-top:1mm}.dn-empty td{height:8mm;padding:0}.dn-sheet footer{margin-top:6mm}
