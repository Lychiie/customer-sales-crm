(() => {
  ...
  style.textContent = `
    ...
    .dn-brand{display:flex;align-items:center;gap:4mm}.dn-company-logo{width:18mm;height:18mm;object-fit:contain;flex:none;print-color-adjust:exact}.dn-brand>div{min-width:0;flex:1}.dn-company h2{font-size:15px;font-weight:600;line-height:1.55;margin:0 0 2mm}.dn-company .dn-address{font-size:10px;line-height:1.65;margin:0}.dn-company small{font-size:9px;line-height:1.6;margin-top:2mm;color:var(--dn-ink)}.dn-address{white-space:pre-wrap;overflow-wrap:anywhere}.dn-kicker{font:600 10px/1.6 Arial,sans-serif;letter-spacing:2px;color:#536174}
