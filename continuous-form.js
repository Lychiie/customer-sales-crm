    ...
    const render=()=>{
      ...
      try{
        ...
        overlay.querySelector('.cf-pages').innerHTML=pages.map((rows,pageIndex)=>{
          ...
          let html=Object.entries(header).map(([k,v])=>field(k,v)).join('');
